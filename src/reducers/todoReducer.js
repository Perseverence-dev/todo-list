  ...
  switch (action.type) {
    ...
    case TODO_ACTIONS.ADD_TODO_START:
      return {
        ...state,
        error: '',
        todoList: [action.payload.temporaryTodo, ...state.todoList],
      };
    ...
    case TODO_ACTIONS.ADD_TODO_SUCCESS:
      return {
        ...
        todoList: state.todoList.map((todo) =>
          todo.id === action.payload.temporaryId ? action.payload.savedTodo : todo
        ),
    ...
    case TODO_ACTIONS.COMPLETE_TODO_SUCCESS:
      return {
        ...state,
        todoList: state.todoList.map((todo) =>
          todo.id === action.payload.savedTodo.id ? action.payload.savedTodo : todo
        ),
        dataVersion: state.dataVersion + 1,
      };
    ...
    default:
      throw new Error(`Unknown todo action type: ${action.type}`);
  }
}